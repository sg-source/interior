    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activation_key_expires', models.DateTimeField(default=datetime.datetime(2020, 10, 11, 18, 34, 54, 224186))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('tagline', models.CharField(blank=True, max_length=128, verbose_name='tagline')),
